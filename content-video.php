...
?>
	...
	<?php if ( !is_search() ) { ?>
		<div class="entry-content">
			...
			<a  class="mt-post-btn mt-radius" href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( esc_html__( 'Permalink to %s', 'rimi' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php echo esc_html__( 'Read More', 'rimi' );  ?></a> <?php	} else { the_content(); }  ?>
		</div>
	<?php } ?>
