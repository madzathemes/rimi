			...
			<div class="row">
				<div class="col-md-12">
					<div class="top-nav <?php echo esc_attr($menu_boxed); ?> container-fluid">
							<div class="nav-button pointer pull-left <?php if ( false == get_theme_mod( 'mt_menu_small_on', false )) { ?>hide-desktop<?php } ?>">
								<div class="mt-m-cool-button">
									<span class="mt-m-cool-button-line"></span>
								</div>
							</div>
...
function rimi_logo() {
	...
	<?php } else { ?>
		<a class="logo"  href="<?php echo esc_url(home_url('/'));?>">
			<img src="<?php echo get_template_directory_uri(); ?>/inc/img/logo.png" width="183" height="48" alt="<?php echo the_title(); ?>" />
		</a>
	<?php }
}
