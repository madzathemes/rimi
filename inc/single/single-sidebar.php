<?php function rimi_single_sidebar() {?>
  ...
  <?php } else { ?>
    ...
    <?php if ( shortcode_exists( 'posts' ) ) { echo do_shortcode('[posts title="'. esc_html__( 'Our Picks','rimi' ) .'"  type=normal offset="3" item_nr=3]'); } ?>
    ...
    <?php  if ( shortcode_exists( 'posts' ) ) { echo do_shortcode('[posts title="'. esc_html__( 'Most Popular','rimi' ) .'" type=small item_nr=5]'); } ?>
